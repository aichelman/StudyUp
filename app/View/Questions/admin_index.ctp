...
<ul class="breadcrumb">
    <li>
        <?php echo $this->Html->link('Quiz', array('controller' => 'practice_tests', 'action' => 'index')); ?>
    ...
    <li class="active"><?php echo __('Questions List'); ?></li>
</ul>
    ...
    <table cellpadding="0" cellspacing="0" id="question_table" class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th class="" style="text-align: center; width:150px"><?php echo __('Actions'); ?></th>
            </tr>
        </thead>
        <tbody>
        ...
        $(document).ready(function(){
            ...
            $("#question_table").tableDnD({
                ...
                onDrop: function(table, row) {
                    ...
                    $.post('<?php echo $this->Html->url('/admin/questions/ordered');?>', params,
                        function(response){}
                    );                    
                }
            });

    ...
    public function register() {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->User->save($this->request->data)) {
                $this->Session->setFlash(__('Thank you for sign up! Now you can log in.'), 'success');
                $this->request->data = null;
                $this->redirect(array('action' => 'login'));
            } else {
                $this->Session->setFlash(__('Register could not be completed. Please, try again.'), 'error');
            }
        }
